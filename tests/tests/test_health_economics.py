...
from edc_he.forms import HealthEconomicsAssetsForm as BaseHealthEconomicsAssetsForm
from edc_he.forms import HealthEconomicsIncomeForm as BaseHealthEconomicsIncomeForm
...
from tests.visit_schedule import visit_schedule


def get_m2m_qs(model_cls, name: str | None = None):
    if name:
...
class HealthEconomicsTests(CrfTestHelper, TestCase):
    @classmethod
    ...
    def setUp(self) -> None:
        ...
        self.subject_visit_baseline = helper.enroll_to_baseline(
    ...
    def get_cleaned_data(self, **kwargs) -> dict:
        ...
        cleaned_data = dict(
            ...
            relationship_to_hoh_other=NULL_STRING,
            hoh_gender=FEMALE,
            hoh_age=25,
    ...
    def test_relationship_to_hoh_applicable_if_not_hoh(self):  # noqa: PLR0915
        instance = HealthEconomicsHouseholdHead()
        opts = dict(
            instance=instance,
            model=HealthEconomicsHouseholdHead,
    ...
    def test_assets_required_before_property_and_income(self):
        ...
        make_recipe("tests.healtheconomicsassets", subject_visit=hoh_obj.subject_visit)
    ...
    def test_property_required_before_income(self):
        ...
        make_recipe("tests.healtheconomicsproperty", subject_visit=hoh_obj.subject_visit)
    ...
    def test_calculated_land_surface_area(self):
        ...
        obj = make_recipe("tests.healtheconomicsproperty", subject_visit=hoh_obj.subject_visit)
        self.assertIsNone(obj.calculated_land_surface_area)

        obj.land_surface_area = 1
        obj.land_surface_area_units = NULL_STRING
        obj.save()
        self.assertIsNone(obj.calculated_land_surface_area)
